...
# Use Default encoding or UTF8, but rely on ASCII markers
$content = Get-Content -Path $path -Raw -Encoding UTF8

$marker = "Credenciais Prefeitura"
$index = $content.IndexOf($marker)

if ($index -ge 0) {
    Write-Host "Found marker '$marker' at index $index"
...
"@
        ...
        # Careful with encoding when writing back to preserve accents in other parts of file
